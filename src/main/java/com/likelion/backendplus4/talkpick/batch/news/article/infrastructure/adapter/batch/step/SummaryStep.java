...
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.partitioner.SummaryPartitioner;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.processor.SummaryProcessor;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.reader.SummaryPageReader;
...
public class SummaryStep {
	...
	public SummaryStep(JobRepository jobRepository,
		SummaryPartitioner partitioner,
		PlatformTransactionManager platformTransactionManager,
		@Qualifier(executorName)
		TaskExecutor taskExecutor,
		SummaryProcessor summaryProcessor,
		ItemWriter<ArticleEntity> articleWriter) {
	 ...
	 */
	@Bean
	public Step articleSummarySlaveStep(SummaryPageReader reader) {
