package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.job;
 ...
 */
@Configuration
public class CollectorBatchJob {
	private final String jobName = "articleCollectorBatchJob";
	private final JobRepository jobRepository;
	private final Step rssPartitionedStep;

	public CollectorBatchJob(JobRepository jobRepository, Step articleRssPartitionedStep) {
