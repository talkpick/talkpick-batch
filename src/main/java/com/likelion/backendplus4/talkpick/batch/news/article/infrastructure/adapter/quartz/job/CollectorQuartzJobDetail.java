 ...
 */
@Configuration
public class CollectorQuartzJobDetail {
	public final String articleCollectorJobDetailName = "articleCollectorJobDetail";


	/**
	 * RSS 수집 Quartz JobDetail 빈 등록.
	 * Job 클래스는 {@link CollectorQuartzJob}이며 다음과 같은 설정을 포함한다:
	...
	public JobDetail articleCollectorJobDetail() {
		return JobBuilder.newJob(CollectorQuartzJob.class)
