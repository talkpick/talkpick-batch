...
@Configuration
@Slf4j
public class EmbeddingQuartzTrigger {
	 ...
	 * @since 2025-05-17
	 */
	public EmbeddingQuartzTrigger(
		@Value("${spring.quartz.article-embedding.cron}") String cronExpression,
		@Qualifier(SummaryAndEmbeddingQuartzJobDetail.ARTICLE_EMBEDDING_JOB_DETAIL_NAME)
	...
	public Trigger articleEmbeddingQuartzTrigger() {
		log.info("Quartz Trigger: " + SummaryAndEmbeddingQuartzJobDetail.ARTICLE_EMBEDDING_JOB_DETAIL_NAME);
		return TriggerBuilder.newTrigger()
			.forJob(articleEmbeddingJobDetail)
			.withIdentity(SummaryAndEmbeddingQuartzJobDetail.ARTICLE_EMBEDDING_JOB_DETAIL_NAME + "trigger")
