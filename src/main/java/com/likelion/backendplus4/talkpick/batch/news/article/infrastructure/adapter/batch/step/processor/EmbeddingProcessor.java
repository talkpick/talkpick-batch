package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.processor;
...
@Component
@Slf4j
public class EmbeddingProcessor implements ItemProcessor<ArticleEntity, ArticleEntity> {
	private final OpenAiApi openAiApi;
	private final String embeddingModelName;

	public EmbeddingProcessor(OpenAiApi openAiApi,
