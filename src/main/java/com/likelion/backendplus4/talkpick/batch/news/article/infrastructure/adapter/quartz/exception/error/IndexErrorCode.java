package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.quartz.exception.error;
...
public enum IndexErrorCode implements ErrorCode {
	TRIGGER_MISS_FIRE(HttpStatus.SERVICE_UNAVAILABLE, 550001, "트리거 작동 실패");
