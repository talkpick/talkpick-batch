package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.reader;
...
@Component
@StepScope
public class CollectorReader implements ItemReader<RssSource> {
	 ...
	 * @author 함예정
	 */
	public CollectorReader(@Value("#{stepExecutionContext['sourceList']}") List<RssSource> sources) {
