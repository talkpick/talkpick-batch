package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.partitioner;
...
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.exception.SummaryException;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.exception.error.ArticleSummaryErrorCode;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.partitioner.dto.ArticleIdRange;
...
public class SummaryPartitioner implements Partitioner {
	 ...
	 * {@link SummaryException}을 {@link ArticleSummaryErrorCode#ITEM_NOT_FOUND}와 함께 발생시킨다.
	 *
	 * @param minId ID 범위의 최소값
	 * @param maxId ID 범위의 최대값
	 * @throws SummaryException 유효하지 않은 ID 범위일 경우
	 *
	 * @author 함예정
	 * @since 2025-05-18
	 */
	private void throwIfInvalidIdRange(Long minId, Long maxId) {
		if (minId == null || maxId == null || minId > maxId) {
			throw new SummaryException(ArticleSummaryErrorCode.ITEM_NOT_FOUND);
		}
	}
