...
@Slf4j
@Configuration
public class SummaryAndEmbeddingQuartzJobDetail {
	public static final String ARTICLE_EMBEDDING_JOB_DETAIL_NAME = "articleEmbeddingJobDetail";

	/**
	 * RSS 수집 Quartz JobDetail 빈 등록.
	 * Job 클래스는 {@link SummaryAndEmbeddingQuartzJob}이며 다음과 같은 설정을 포함한다:
	...
	public JobDetail articleEmbeddingJobDetail() {
		return JobBuilder.newJob(
				SummaryAndEmbeddingQuartzJob.class)
