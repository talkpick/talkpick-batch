package com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step;
...
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.exception.EmbeddingException;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.partitioner.EmbeddingPartitioner;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.processor.EmbeddingProcessor;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.reader.EmbeddingPageReader;
import com.likelion.backendplus4.talkpick.batch.news.article.infrastructure.adapter.batch.step.writer.ArticleWriter;
...
public class EmbeddingStep {
	...
	public Step articleEmbeddingStep(
		EmbeddingPartitioner partitioner,
